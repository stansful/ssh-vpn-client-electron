...
export function KeyForm({
  ...
  return (
    <form className="modal-form" onSubmit={onSubmit}>
      {error && <div className={error.includes("copied") ? "inline-success modal-error" : "inline-error modal-error"}>{error}</div>}
      ...
      {draft.mode === "edit" && (
        <div className="inline-actions">
          <button type="button" className="ghost-button" onClick={() => onCopySavedPrivateKey(draft.id)}>
